...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Xh1zFvPi.js");
...
const manifest = {
  "d8fbd25ade938994a2d4afd161eeda3f9f5ee4ea67b5926a626400851f88df64": {
    functionName: "searchIndianCity_createServerFn_handler",
    importer: () => import("./opentripmap.functions-jMqmnkoR.js")
  },
  "032a844bc5fdb6404134046a5a0dcf3efc2460432d2f96b33574f5fbc48fe655": {
    functionName: "searchIndiaPlaces_createServerFn_handler",
    importer: () => import("./india-search.functions-Cy8IZY5T.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C-aH7qSq.js").then((n2) => n2.r),
